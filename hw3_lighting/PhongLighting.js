...
function main() {
    ...
    var sourceDiffuse = [1.0, 1.0, 1.0];
    var materialDiffuse = [1.0, 0.0, 0.0];
    var sourceSpecular = [1.0, 1.0, 1.0];
    var materialSpecular = [0.7, 0.7, 0.7];
    var sourceAmbient = [0.8, 0.8, 0.8];
    var materialAmbient = [0.2, 0.2, 0.2];
    var materialEmissive = [0.2, 0.2, 0.0];
    ...
    gl.uniform3fv(sD, sourceDiffuse);
    gl.uniform3fv(mD, materialDiffuse);
    gl.uniform3fv(sS, sourceSpecular);
    gl.uniform3fv(mS, materialSpecular);
    gl.uniform3fv(sA, sourceAmbient);
    gl.uniform3fv(mA, materialAmbient);
    gl.uniform3fv(mE, materialEmissive);
    gl.uniform1f(mSh, materialShininess);
